...
class Person extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('admin/layouts/template', 'admin/persons/index', $data);
    }

    public function add()
    {
        $data = konfigurasi('Tambah Person', 'Tambah Person');
        $this->template->load('admin/layouts/template', 'admin/persons/create', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->template->load('admin/layouts/template', 'admin/persons/update', $data);
    }
    ...
    public function detail($id)
    {
        ...
        $data['person'] = $this->Person_model->get_by_id($id);
        $this->template->load('admin/layouts/template', 'admin/persons/detail', $data);
    }
